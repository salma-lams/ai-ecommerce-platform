        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 sm:px-8 lg:px-12">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#E8611A] text-[9px] font-bold text-white shadow-sm ring-2 ring-white dark:ring-black animate-in zoom-in">
                  {cartCount}
                </span>
              )}
            </button>
